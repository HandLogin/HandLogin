...
const YOUR_APP_NAME = "Nadav's application";
...
function resultHere(hook, status, resultOrError) {

}

// Don't touch

function call(endpoint = null, action = null, parameters = null, callback = null) {
    // Create a form
    ...
    // Final URL
    let url = "http://cs.kipod.club/apis/" + endpoint + "/" + "?" + action + query;
    // Log
